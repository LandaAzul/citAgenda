                        ...
                        {pagina === 3 ?
                            <div className="w3-text-indigo">
                                ...
                                <p style={{ textAlign: 'justify' }}>
                                    ...
                                    <b>“mostrar completo”</b> el cual permitirá que los usuarios visualicen el horario en la semana completa, si apaga esta función sólo se visualizará el dia presente y el siguiente dia en el horario, ocultando los demás días,
                                    ...
                                    <b>Crear nuevo horario:</b> en esta parte el administrador puede crear la cantidad de horarios que desee, seleccionar primero los días para los cuales las franjas serán repetitivas, si por ejemplo los sábados las franjas
