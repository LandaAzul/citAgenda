...
authCtrl.singUp = async (req, res) => {
    try {
    const {nombre,celular,contra,email,codigo,documento,activo,idFamiliares,tipo,roles} = req.body;
    ...
    } else { //si no se ingreso ningun rol, asigna el rol user por defecto
