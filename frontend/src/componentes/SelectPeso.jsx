...
export function SelectPeso({ minimo, maximo, intervalo, value, onChange }) {
    ...
    const cerrar = document.getElementById('selectNumber');
    ...
    return (
        <div >
            <div id='selectNumber' style={{ position: 'relative' }} className="w3-input w3-border w3-round-large w3-text-black" onClick={e => { setmostrar(!mostrar); crearListado() }}>
                {salida}
