...
export function TextoInformativo() {
                ...
                <>
                    {
                        imagenes[control2] !== undefined ?
                            <div className="presentar">
                                <img src={imagenes[control2].imagen} alt="imágenes subidas por parte del administrador" className="present" />
                                {imagenes.length > 1 ?
                                    <div>
    ...
    return (
        <>
            ...
            {mostrarCampo ?
                <div className="w3-container w3-center w3-metro-dark-orange">
                    <div style={TextoEstilo} onClick={e => setMostrar(!mostrar)} className="w3-padding w3-metro-dark-orange w3-center">
                    ...
                    {mostrar ?
                        ...
                        : null}
                    <div className="w3-col m12 w3-padding w3-metro-dark-orange w3-center">
                    </div>
                </div>
                : null}
        </>
