...
export default function AuthProvider({ children }) {
    ...
    const login = (userCredentials ) => {
        setUser({ id: userCredentials.data.userFound._id, nombre: userCredentials.data.userFound.nombre, estado: userCredentials.data.userFound.estado, role: userCredentials.data.userFound.rol[0].name, token: userCredentials.data.token });
